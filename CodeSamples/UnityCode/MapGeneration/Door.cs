...
public class Door : MonoBehaviour
{
    ...
    //This whole thing is kinda nasty BUT it allows for more easy room size adjustments in the future and prevents fuckiness with previously attempted methods
    ...
    public void FindNextRoom()
    {
        ...
        //If this door has already had it's corresponding connection set
        ...
        if (MapController.instance.RoomMap.ContainsKey(NextTile))
        {

            Room room = MapController.instance.RoomMap[NextTile];
            room.HasTile(this);
            Connected = true;
