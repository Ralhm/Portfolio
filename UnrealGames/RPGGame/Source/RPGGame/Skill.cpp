...
//player/skill copmonent is responsible for calculating damage to target
...
//this way we can modify damage calculations and outputs for each skill
...
float USkill::CalculateDamage(ARPGCharacter* Target, ARPGCharacter* User) {
